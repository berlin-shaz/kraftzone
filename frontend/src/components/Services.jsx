    ...
    <div className="max-w-6xl w-full">
      ...
      <div className="text-center md:text-left mb-10">
        ...
        <div className="flex items-center justify-center md:justify-start mt-4">
          ...
          <span className="ml-4 text-gray-600">Professional and Experienced staff ready to help you</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {services.map((service, index) => (
          <div key={index} className="relative group bg-white rounded-lg overflow-hidden shadow-lg">
            <img
              src={service.image}
              alt={service.title}
            ...
            <button className="absolute bottom-4 right-4 p-3 bg-blue-900 text-white rounded-full shadow-lg transform group-hover:scale-110 transition duration-300 ease-in-out">
              <FaArrowRight />
            </button>
          </div>
        ))}
